...
public class EditNotificationService {
    ...
    public void sendEditNotification(PetLicenseRequest request, Map<String, Difference> diffMap) {
...
//                break;
     ...
     */
    private List<SMSRequest> enrichSMSRequest(PetLicenseRequest request, Map<String, Difference> diffMap) {
