...
import org.egov.pl.models.Difference;
...
public class DiffService {
     ...
     */
    private List<String> getUpdatedFields(PetLicense licenseFromUpdate, PetLicense licenseFromSearch) {
     ...
     */
    private List<String> getObjectsAdded(PetLicense licenseFromUpdate, PetLicense licenseFromSearch) {
     ...
     * @return Names of Classes added or removed during update
     */
    private List<String> getObjectsRemoved(PetLicense licenseFromUpdate, PetLicense licenseFromSearch) {
